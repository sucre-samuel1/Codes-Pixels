...
export function Services() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            ...
            <button className="mt-6 bg-purple-600 text-white px-4 py-2 rounded-md text-sm hover:bg-blue-700 transition-colors">
              Get Started
            </button>
          </div>
  ...
  <button className="mt-6 bg-purple-600 text-white px-4 py-2 rounded-md text-sm hover:bg-purple-700 transition-colors">
    Learn More
  </button>
</div>
